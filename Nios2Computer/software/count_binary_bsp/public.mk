...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Nios2Computer.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Nios2Computer
SOPC_NAME := Nios2Computer
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1550170400
SOPC_SYSID_FLAG += --timestamp=1550170400
ELF_PATCH_FLAG  += --timestamp 1550170400
