...
HD_PWD='C:/FPGAJosieVivian/ZynqComputer/ZynqComputer.runs/Zynq_CPU_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_CPU_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_CPU_processing_system7_0_0.tcl
