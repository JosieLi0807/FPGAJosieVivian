...
// ==============================================================
#ifndef __hls_multiplier_mubkb__HH__
#define __hls_multiplier_mubkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_multiplier_mubkb) {
    ...
    SC_CTOR(hls_multiplier_mubkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
