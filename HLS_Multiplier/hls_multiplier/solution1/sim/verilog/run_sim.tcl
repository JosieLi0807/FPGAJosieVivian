...
if {[file isfile hls_multiplier.autotvin.dat]} {
	file delete -force hls_multiplier.autotvin.dat
}

if {[file isfile hls_multiplier.autotvout.dat]} {
	file delete -force hls_multiplier.autotvout.dat
}
