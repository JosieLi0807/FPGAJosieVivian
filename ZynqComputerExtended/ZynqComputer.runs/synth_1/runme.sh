...
HD_PWD='C:/FPGAJosieVivian/ZynqComputerExtended/ZynqComputer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_CPU_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_CPU_wrapper.tcl
