...
HD_PWD='C:/FPGAJosieVivian/ZynqComputerExtended/ZynqComputer.runs/Zynq_CPU_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_CPU_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_CPU_rst_ps7_0_100M_0.tcl
