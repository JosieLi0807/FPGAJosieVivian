...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir C:/FPGAJosieVivian/ZynqComputerExtended/ZynqComputer.runs/Zynq_CPU_xbar_0_synth_1 -new_name Zynq_CPU_xbar_0 -ip [get_ips Zynq_CPU_xbar_0]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top Zynq_CPU_xbar_0 -part xc7z020clg400-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix Zynq_CPU_xbar_0_ Zynq_CPU_xbar_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Zynq_CPU_xbar_0_stub.v
 lappend ipCachedFiles Zynq_CPU_xbar_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Zynq_CPU_xbar_0_stub.vhdl
 lappend ipCachedFiles Zynq_CPU_xbar_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Zynq_CPU_xbar_0_sim_netlist.v
 lappend ipCachedFiles Zynq_CPU_xbar_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Zynq_CPU_xbar_0_sim_netlist.vhdl
 lappend ipCachedFiles Zynq_CPU_xbar_0_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp Zynq_CPU_xbar_0.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips Zynq_CPU_xbar_0]
}

rename_ref -prefix_all Zynq_CPU_xbar_0_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Zynq_CPU_xbar_0.dcp
