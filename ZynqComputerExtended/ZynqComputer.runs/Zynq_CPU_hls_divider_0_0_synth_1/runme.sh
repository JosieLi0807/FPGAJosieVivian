...
HD_PWD='C:/FPGAJosieVivian/ZynqComputerExtended/ZynqComputer.runs/Zynq_CPU_hls_divider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_CPU_hls_divider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_CPU_hls_divider_0_0.tcl
