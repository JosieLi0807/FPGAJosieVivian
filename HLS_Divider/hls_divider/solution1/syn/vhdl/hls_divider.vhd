...
architecture behav of hls_divider is 
    ...
    "hls_divider,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.649000,HLS_SYN_LAT=19,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=536,HLS_SYN_LUT=515,HLS_VERSION=2018_3}";
    ...
    signal grp_fu_36_p2 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    component hls_divider_udiv_bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component hls_divider_urem_cud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    hls_divider_CRTLS_s_axi_U : component hls_divider_CRTLS_s_axi
    generic map (
    ...
    hls_divider_udiv_bkb_U1 : component hls_divider_udiv_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 20,
        din0_WIDTH => 16,
    ...
    hls_divider_urem_cud_U2 : component hls_divider_urem_cud
    generic map (
        ID => 1,
        NUM_STAGE => 20,
        din0_WIDTH => 16,
    ...
    ap_return <= (grp_fu_36_p2 & grp_fu_42_p2);
