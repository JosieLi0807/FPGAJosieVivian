...
// ==============================================================
#ifndef __hls_divider_urem_cud__HH__
#define __hls_divider_urem_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_divider_urem_cud) {
    ...
    SC_CTOR(hls_divider_urem_cud):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
