# ==============================================================
# File generated on Thu Mar 21 15:27:38 -0400 2019
...
if {[file isfile hls_divider.autotvin.dat]} {
	file delete -force hls_divider.autotvin.dat
}

if {[file isfile hls_divider.autotvout.dat]} {
	file delete -force hls_divider.autotvout.dat
}
